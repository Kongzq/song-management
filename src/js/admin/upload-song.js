  ...
  let controller = {
    ...
    initQiniu(){
      var uploader = Qiniu.uploader({
        ...
        domain: 'p5kukb6ly.bkt.clouddn.com',   //bucket 域名，下载资源时用到，**必需**
        ...
        init: {
          ...
          'FileUploaded': (up, file, info) => {
            ...
            var sourceLink = 'http://' + domain + '/' + encodeURIComponent(response.key);  //response.key含有中文，所以encode
            window.eventHub.emit('new', {
              url: sourceLink,  //上传的歌曲的外链url
              name: response.key  //上传的歌曲的'歌名-歌手'
            })
          },
